...
<head>
    ...
    <!-- CSS
  ================================================== -->
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/error/base.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/error/main.css') }}">
    <link rel="stylesheet" type="text/css" href=href="{{ asset('assets/css/error/vendor.css') }}">

    <!-- script
    ================================================== -->
    <script src="{{ asset('assets/js/error/modernizr.js') }}"></script>
...
<!-- Java Script
================================================== -->
<script type="text/javascript" src="{{ asset('assets/js/error/jquery-2.1.3.min.js') }}"></script>
<script src="{{ asset('assets/js/error/plugins.js') }}"></script>
